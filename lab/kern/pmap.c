...
i386_detect_memory(void)
{
	...
	//本机可用的内存大小为128MB，可用的页为131072/4=32768
...
mem_init(void)
{
	...
	//cprintf("test kern_pgdir: %08x %d %08x\n", kern_pgdir, PDX(kern_pgdir), PADDR(kern_pgdir));
	//////////////////////////////////////////////////////////////////////
	...
	//cprintf("now test: %d %d\n", npages, npages*sizeof(struct PageInfo));
...
pgdir_walk(pde_t *pgdir, const void *va, int create)
{
	...
	//返回表的虚地址
	//cprintf("out %08x\n", (KADDR(PTE_ADDR(*pgdir_entry))) + PTX(va));
	//pte_t * temp = (pte_t *)0xf0001000;
	//cprintf("%08x %08x", &temp, (physaddr_t)temp);
